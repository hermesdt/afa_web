...
class TechniqueTypesControllerTest < ActionController::TestCase
  setup do
    @technique_type = technique_types(:one)
  end
  ...
  test "should create technique_type" do
    ...
    assert_redirected_to technique_type_path(assigns(:technique_type))
  end
  ...
  test "should destroy technique_type" do
    ...
    assert_redirected_to technique_types_path
  end
end
